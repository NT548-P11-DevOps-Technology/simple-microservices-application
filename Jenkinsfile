pipeline {
    ...
    stages {
        ...
        stage('Deploy to Kubernetes') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'kubernetes', contextName: '', credentialsId: 'k8s-token', namespace: 'default', restrictKubeConfigAccess: false, serverUrl: 'https://ec2-13-212-36-112.ap-southeast-1.compute.amazonaws.com:6443') {
